    ...
    <nav class="navbar navbar-expand-md navbar-light my-3">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item "><a class="nav-link" href="https://localhost/bootstrap/_project_imob/index.php">Home</a></li>
                    <li class="nav-item "><a class="nav-link text-front" href="https://localhost/bootstrap/_project_imob/index.php?app=single">Destaque</a></li>
                    <li class="nav-item "><a class="nav-link" href="https://localhost/bootstrap/_project_imob/index.php?app=filtro">Alugar</a></li>
                    <li class="nav-item "><a class="nav-link" href="https://localhost/bootstrap/_project_imob/index.php?app=filtro">Comprar</a></li>
                    <li class="nav-item "><a class="nav-link" href="https://localhost/bootstrap/_project_imob/index.php?app=contato">Contato</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container pt-5" style="padding-bottom: 110px">
        <div class="row justify-content-around text-muted">
            ...
            <div class="col-12 col-md-9 col-lg-6">
                ...
                <p>Nosso maior satisfação é lhe ajudar a encontrar seu imóvel dos sonhos nos bairros do Sul da Ilha da
...
<div class="main_copyright py-3 bg-front text-white text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="mb-0">Imobiliária | CRECI 1234 | Avenida Pequeno Principe, 0 Campeche, Florianópolis/SC</p>
                <p class="mb-0">Todos os Direitos Reservados - Mdev Startup</p>
            </div>
        </div>
    </div>
</div>
